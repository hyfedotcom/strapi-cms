...
export interface ApiGlobalGlobal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'layout.layout-footer', false>;
    general_setting: Schema.Attribute.Component<
      'layout.layout-general-settings',
      false
    >;
    header: Schema.Attribute.Component<'layout.layout-header', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
